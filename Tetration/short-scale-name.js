...
,ConvertTier0 = function(n){// 1 <= n <= 999
   var d21=n%100;
...
,ConvertStdIllion = function(n){return n<100?n>=10?_tier1[n%10]+_ty1f[Math.floor(n/10)-1]:_tier1f[n]:n==100?'centillion':'('+n+')illion'}// 0 <= n <= 100
,ShortScaleName = function(x){
